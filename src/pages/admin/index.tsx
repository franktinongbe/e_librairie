...
export default function AdminIndex(){
  ...
  return (
    <Layout>
      <PageHeader title="Panneau Admin" actions={(
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            ...
            <p className="text-sm text-ink-300 mb-4">Créer, modifier ou supprimer des articles.</p>
          ...
          <Card>
            ...
            <p className="text-sm text-ink-300 mb-4">Gérer les fournisseurs et leurs coordonnées.</p>
            <div>
          ...
          <Card>
            ...
            <p className="text-sm text-ink-300 mb-4">Consulter les ventes et générer des factures.</p>
            <div className="flex gap-2">
